...
public class MySQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public String CREATE_BUS_TABLE = "create table "+BUS_TABLE+"("+BUS_ID+" integer primary key,"+" " +
            ""+BUS_NAME+"text,"+BUS_PIC+" text,"+BUS_DETAIL+" text);";
    ...
    private static final String CREATE_PLACE_TABLE = "create table" + PLACE_TABLE + "("+PLACE_ID+" text primary key,"+" " +
            ""+PLACE_NAME+" text,"+PLACE_PIC+" text,"+PLACE_DETAIL+" text,"+PLACE_LAT+" text"+PLACE_LONG+" text);";
